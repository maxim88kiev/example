...
public interface GameConstants {
	...
	//размер стола
		...
		public final int RACKET_WIDCH = 5;
		public final int WINNING_SCORE = 21;
		
		//Заметитть быстрые компьютеры - измените это значение если понадобиться
		public final int SLEEP_TIME = 10; //Время в милисекундах
